...
{
    /**
     * In development environment we want to give owner role to the first signed up user.
     ...
     * @return boolean     True if owner role is assigned or if there was no need to do it.
     */
    public static function assignRole($id)
    {
        ...
        // this is first user ( you ), lets give you the owner role
        ...
        return ($info->roleName == "owner") ? true : false ;
    }
}
